...
shinyServer(function(input, output, session) {
  ...
  # Anna note - need to revert from pctbike
  output$cite_html <- renderUI({
    HTML(paste('Version', a(repo_sha, href = paste0("https://github.com/pctbike/pct02_shiny_interface/tree/", repo_sha), target = '_blank'),
  ...
  # This file updates whenever there is a change to input$region, and content of links also depends on repo_sha or outputs_regional_sha
  ...
  # Content of links in this file depend on repo_sha & outputs_national_sha, hence not static and needs to be generated here
